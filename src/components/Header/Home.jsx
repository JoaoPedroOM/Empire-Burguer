...
const Home = () => {
  return (
    ...
    <div className='absolute mt-28 lg:mt-[80px] sm:ml-6 2xl:ml-24 ml-72'>
    ...
    <img src={bannerMobile} alt="home" className='hidden w-full h-full md:block' />
    <img src={bannerHeader} alt="" className='w-full h-full object-cover md:hidden' />
  </div>
  )
}
